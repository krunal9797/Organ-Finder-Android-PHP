...
public class ABnegative extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_bnagative);
        allocatememory();
        setEvenets();
    }
    ...
    private void setEvenets()
    {
        eyes.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent eyes = new Intent(getApplicationContext(), FetchABNEyes.class);
                startActivity(eyes);
            }
        });
        heart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent heart = new Intent(getApplicationContext(), FetchABNHeart.class);
                startActivity(heart);
        ...
        lung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lung = new Intent(getApplicationContext(), FetchABNLung.class);
                startActivity(lung);
        ...
        kidney.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kidney = new Intent(getApplicationContext(), FetchABNKidney.class);
        ...
        liver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent liver = new Intent(getApplicationContext(), FetchABNLiver.class);
                startActivity(liver);
