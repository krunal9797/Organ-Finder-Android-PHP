...
import com.example.orgendonation.Fetch.FetchAPEyes;
import com.example.orgendonation.Fetch.FetchAPHeart;
import com.example.orgendonation.Fetch.FetchAPKidney;
import com.example.orgendonation.Fetch.FetchAPLiver;
import com.example.orgendonation.Fetch.FetchAPLung;
...
public class Apositive extends AppCompatActivity {
    ...
    private void setEvenets()
    {
        eyes.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent eyes = new Intent(getApplicationContext(), FetchAPEyes.class);
                startActivity(eyes);
            }
        });
        heart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent heart = new Intent(getApplicationContext(), FetchAPHeart.class);
                startActivity(heart);
        ...
        lung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lung = new Intent(getApplicationContext(), FetchAPLung.class);
                startActivity(lung);
        ...
        kidney.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kidney = new Intent(getApplicationContext(), FetchAPKidney.class);
        ...
        liver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent liver = new Intent(getApplicationContext(), FetchAPLiver.class);
                startActivity(liver);
