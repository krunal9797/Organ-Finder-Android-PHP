...
public class Anegative extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anagative);
        allocatememory();
        setEvenets();
    }
    ...
    private void setEvenets()
    {
        eyes.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent eyes = new Intent(getApplicationContext(), FetchANEyes.class);
                startActivity(eyes);
            }
        });
        heart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent heart = new Intent(getApplicationContext(), FetchANHeart.class);
                startActivity(heart);
        ...
        lung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent lung = new Intent(getApplicationContext(), FetchANLung.class);
                startActivity(lung);
        ...
        kidney.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kidney = new Intent(getApplicationContext(), FetchANKidney.class);
        ...
        liver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent liver = new Intent(getApplicationContext(), FetchANLiver.class);
                startActivity(liver);
