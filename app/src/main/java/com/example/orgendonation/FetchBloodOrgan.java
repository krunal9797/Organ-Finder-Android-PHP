...
public class FetchBloodOrgan extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fetch_blood_organ);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbloodorgan(new Callback<FetchBloodOrganModel>()
        {
            @Override
