...
public class FetchABPKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_p_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabnlung(new Callback<FetchBloodOrganModel>()
        {
            @Override
