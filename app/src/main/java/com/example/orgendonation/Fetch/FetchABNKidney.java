...
public class FetchABNKidney extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fetch_a_b_n_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabnkideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
