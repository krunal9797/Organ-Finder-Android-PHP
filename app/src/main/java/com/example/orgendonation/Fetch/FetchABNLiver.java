...
public class FetchABNLiver extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_n_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabnliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
