...
public class FetchABNEyes extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_n_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabneyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
