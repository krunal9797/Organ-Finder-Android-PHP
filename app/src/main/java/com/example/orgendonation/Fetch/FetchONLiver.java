...
public class FetchONLiver extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_o_n_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fonliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
