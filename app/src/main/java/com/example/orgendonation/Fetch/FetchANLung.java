...
public class FetchANLung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_n_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fanlung(new Callback<FetchBloodOrganModel>()
        {
            @Override
