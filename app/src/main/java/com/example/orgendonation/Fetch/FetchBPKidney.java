...
public class FetchBPKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_p_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbpkideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
