...
public class FetchONEyes extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fetch_o_n_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().foneyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
