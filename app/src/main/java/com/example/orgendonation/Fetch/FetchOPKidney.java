...
public class FetchOPKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_op_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fopkideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
