...
public class FetchANEyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_n_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().faneyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
