...
public class FetchABPLiver extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_p_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabpliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
