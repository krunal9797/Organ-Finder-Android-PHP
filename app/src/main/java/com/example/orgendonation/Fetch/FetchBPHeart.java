...
public class FetchBPHeart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_p_heart);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbpheart(new Callback<FetchBloodOrganModel>()
        {
            @Override
