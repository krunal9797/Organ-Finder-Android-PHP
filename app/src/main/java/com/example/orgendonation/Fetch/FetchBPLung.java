...
public class FetchBPLung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_p_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbplung(new Callback<FetchBloodOrganModel>()
        {
            @Override
