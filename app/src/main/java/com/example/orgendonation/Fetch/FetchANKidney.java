...
public class FetchANKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_n_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fankideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
