...
public class FetchOPLung extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_op_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().foplung(new Callback<FetchBloodOrganModel>()
        {
            @Override
