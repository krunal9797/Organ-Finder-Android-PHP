...
public class FetchAPEyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_p_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fapeyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
