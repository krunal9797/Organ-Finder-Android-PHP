...
public class FetchABPEyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_p_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabpeyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
