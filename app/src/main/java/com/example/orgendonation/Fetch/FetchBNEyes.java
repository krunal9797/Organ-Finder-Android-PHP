...
public class FetchBNEyes extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_n_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbnlung(new Callback<FetchBloodOrganModel>()
        {
            @Override
