...
public class FetchAPHeart extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_p_heart);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fapheart(new Callback<FetchBloodOrganModel>()
        {
            @Override
