...
public class FetchANLiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_n_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fanliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
