...
public class FetchAPLung extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fetch_a_p_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().faplung(new Callback<FetchBloodOrganModel>()
        {
            @Override
