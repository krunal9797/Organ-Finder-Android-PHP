...
public class FetchABNHeart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_n_heart);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabnheart(new Callback<FetchBloodOrganModel>()
        {
            @Override
