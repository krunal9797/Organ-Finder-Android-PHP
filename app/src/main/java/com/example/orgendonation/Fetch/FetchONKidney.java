...
public class FetchONKidney extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_o_n_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fonkidney(new Callback<FetchBloodOrganModel>()
        {
            @Override
