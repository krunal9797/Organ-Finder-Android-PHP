...
public class FetchAPLiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_p_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fapliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
