...
public class FetchBPLiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_p_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbpliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
