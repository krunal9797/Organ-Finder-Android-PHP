...
public class FetchAPKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_p_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fapkideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
