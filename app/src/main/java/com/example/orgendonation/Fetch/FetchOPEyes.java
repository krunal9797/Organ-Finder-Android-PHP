...
public class FetchOPEyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_o_p_eyes);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fopeyes(new Callback<FetchBloodOrganModel>()
        {
            @Override
