...
public class FetchBNKidney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_n_kidney);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbnkideny(new Callback<FetchBloodOrganModel>()
        {
            @Override
