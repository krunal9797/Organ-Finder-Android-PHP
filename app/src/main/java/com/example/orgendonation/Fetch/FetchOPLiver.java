...
public class FetchOPLiver extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fetch_op_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fopliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
