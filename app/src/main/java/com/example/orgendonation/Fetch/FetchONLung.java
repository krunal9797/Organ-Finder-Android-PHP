...
public class FetchONLung extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_o_n_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fonlung(new Callback<FetchBloodOrganModel>()
        {
            @Override
