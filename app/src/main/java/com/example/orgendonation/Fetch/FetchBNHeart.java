...
public class FetchBNHeart extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_n_heart);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbnheart(new Callback<FetchBloodOrganModel>()
        {
            @Override
