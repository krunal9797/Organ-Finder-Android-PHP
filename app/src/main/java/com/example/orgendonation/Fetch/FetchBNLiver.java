...
public class FetchBNLiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_b_n_liver);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fbnliver(new Callback<FetchBloodOrganModel>()
        {
            @Override
