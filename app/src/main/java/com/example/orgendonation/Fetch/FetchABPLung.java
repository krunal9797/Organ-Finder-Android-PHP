...
public class FetchABPLung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_a_b_p_lung);
    ...
    private void getTopProductList()
    {
        ...
        ApiHandler.getApiService().fabplung(new Callback<FetchBloodOrganModel>()
        {
            @Override
