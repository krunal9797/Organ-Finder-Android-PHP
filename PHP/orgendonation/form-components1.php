...
<head>
  ...
  <body class="app sidebar-mini rtl">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage State</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="form-components.html"><i class="icon fa fa-caret-right"></i> Add State</a></li>
            <li><a class="treeview-item" href="form-components.html"><i class="icon fa fa-caret-right"></i> View State</a></li>
          </ul>
        </li>

       <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage Orgens</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="form-components1.html"><i class="icon fa fa-caret-right"></i> Add Orgens</a></li>
            <li><a class="treeview-item" href="form-components.html"><i class="icon fa fa-caret-right"></i> View Orgens</a></li>
          </ul>
        </li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Manage Orgens</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
              ...
              <div class="col-lg-6">
                <form>
                   ...
                   <div class="form-group">
                    <label for="exampleInputPassword1">Orgens</label>
                    <input class="form-control" id="orgens_name" type="text" placeholder="Enter Name">
                  </div>
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" value="Submit" name="save" type="submit">Submit</button>
			    </form>
            </div>
          </div>
        </div>
