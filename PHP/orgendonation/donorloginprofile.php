<?php 
include "config.php";
$sql = "SELECT * FROM donorlogin ORDER BY id ASC";
//execute the query
              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                    <label for="exampleSelect1">Donor User</label>
					<div class="container">
...
<table class="table">
	...
	?>
					...
					<td><?php echo $row['d_pwd']; ?></td>
					<td>
					<a class="btn btn-danger" href="donerlogindelete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
					</tr>	
