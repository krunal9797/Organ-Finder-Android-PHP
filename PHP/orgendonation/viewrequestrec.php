...
<head>
  ...
  <body class="app sidebar-mini rtl">
	...
	<li class="treeview"><a class="app-menu__item" href="viewrequestrec.php" data-toggle="treeview"><i class="app-menu__icon fa fa-user">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> View Organs Request</h1>
              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                                    <label for="exampleSelect1">View Organs Request</label>
					<div class="container">
		...
		<?php
			if ($result->num_rows > 0) 
			{
				...
				?>
					...
					<td><?php echo $row['r_cnum']; ?></td>
					<td><?php echo $row['r_orgen']; ?></td>
					<td><?php echo $row['r_bloodgroup']; ?></td>
					<td><?php echo $row['r_disease']; ?></td>
					<td><?php echo $row['r_description']; ?></td>
					<td><a class="btn btn-danger" href="deleteviewrequest.php?id=<?php echo $row['id']; ?>">Delete</a></td>
					</tr>	
