...
<head>
  ...
  <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Receipient User Login</h1>
              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                    <label for="exampleSelect1">Receipient User</label>
					<div class="container">
<table class="table">
	<thead>
		<tr>
	...
	?>
					...
					<td>
					<a class="btn btn-danger" href="receipientlogindelete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
					</tr>	
