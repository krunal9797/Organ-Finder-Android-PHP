...
<head>
  ...
  <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user">
        ...
        <li class="treeview"><a class="app-menu__item" href="addstate.php" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage State</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
       ...
       <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage Organs</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="treeview"><a class="app-menu__item" href="dashboard.php" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage User</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="Userprofile.php"><i class="icon fa fa-caret-right"></i> Donor Profile</a></li>
        <li><a class="treeview-item" href="donorloginprofile.php"><i class="icon fa fa-caret-right"></i> Donor login details</a></li>
        <li><a class="treeview-item" href="receipientprofile.php"><i class="icon fa fa-caret-right"></i> Receipient Profile</a></li>         <li><a class="treeview-item" href="receipientloginprofile.php"><i class="icon fa fa-caret-right"></i> Receipient login details</a></li>      
          </ul>
        </li>
      </ul>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> View Organs</h1>
              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                                    <label for="exampleSelect1">View Organs</label>
					<div class="container">
		...
		<?php
			if ($result->num_rows > 0) 
			{
				...
				?>
					...
					<td><?php echo $row['orgens_name']; ?></td>
