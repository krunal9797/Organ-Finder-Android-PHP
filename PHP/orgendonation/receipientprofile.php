...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `recreg` WHERE CONCAT( 'id', `r_name`, `r_email`, `r_state`, `r_category`, `r_city`, `r_contact`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `recreg`";
    $search_result = filterTable($query);
}
...
<!-- Navbar Right Menu-->
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Receipient Profile</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
			  <div class="container">
			  <form action="receipientprofile.php" method="post">
