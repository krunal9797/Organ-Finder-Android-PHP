...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `donorreg` WHERE CONCAT( 'id', `d_name`, `d_email`, `d_state`, `d_category`, `d_city`, `d_contact`) LIKE '%".$valueToSearch."%'";
  ...
  <body class="app sidebar-mini rtl">
	...
	<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user">
       ...
       <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage Organs</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="treeview"><a class="app-menu__item" href="Userprofile.php" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Manage User</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
